<x-admin-layout>
    ...
    <div class="space-y-6">
        ...
        {{-- Single CSV import for all teams --}}
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="font-semibold text-gray-800 text-lg mb-1">Import Rosters from CSV</h2>
            <p class="text-sm text-gray-500 mb-4">
                Upload one CSV with all players across all programs.
                Required columns: <code class="bg-gray-100 px-1 rounded">Name</code>,
                <code class="bg-gray-100 px-1 rounded">Team</code> (Sparks / Kindergarten / 1st Grade).
                Optional: <code class="bg-gray-100 px-1 rounded">Role</code> — put "Coach" on the coach's row.<br>
                Uploading replaces all existing rosters.
            </p>
            ...
            <div class="mt-4 bg-gray-50 border border-gray-200 rounded p-3 text-xs text-gray-500 font-mono">
                Name,Team,Role<br>
                Alex Smith,Sparks,<br>
                Coach Jane,Sparks,Coach<br>
                Jordan Lee,Kindergarten,<br>
                Sam Rivera,1st Grade,
            </div>
        </div>

        {{-- Team cards — format info only --}}
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" name="coach_name" value="{{ old('coach_name', $team->coach_name) }}"
                               placeholder="Set via CSV or enter manually"
                               class="w-full border border-gray-300 rounded px-3 py-1.5 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
