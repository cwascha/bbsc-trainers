<nav x-data="{ open: false }" class="bg-white border-b border-gray-200 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-1 sm:ms-8 sm:flex">
                    ...
                    <x-nav-link :href="route('training-plans.index')" :active="request()->routeIs('training-plans.*')">
                        Training Plans
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('training-plans.index')" :active="request()->routeIs('training-plans.*')">
                Training Plans
            </x-responsive-nav-link>
